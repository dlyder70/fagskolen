const express = require('express'); // bruker node.js express web 
app framework 
...
res.send(clockNow + '. <br/><br/>Kalkulator på <a 
href="./timeconv">/timeconv</a> .<br/>UnixEpochTime på <a 
href="./unixepoch">/unixepoch</a> .<br><br>Aksessert fra ' + 
accessedBy); 
}); 
